...
from security1.authentication.authentication import authenticate, create_access_token
from security1.authentication.models import AccessTokenTortoise, User, UserCreate, UserDB, UserTortoise
from security1.authentication.password import get_password_hash
...
TORTOISE_ORM = {
    'connections': {'default': 'sqlite:///c:\\Users\\PatCa\\Documents\\PythonScripts\\fast_api_setup\\security1\\authentication.db'},
    'apps': {
        'models': {
            'models':['security1.authentication.models'], 
            'defualt_connection': 'default',
                    },
                },
    'user_tz': True,
            }
